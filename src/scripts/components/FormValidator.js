export default class FormValidator {
        ...
        popupOpenButtons.forEach((button) => {
             ...
             button.addEventListener('click', () => {
                  if (validatingInput.classList.contains(this._errorClass)) {
                      ...
                      const spanReset = validatingInput.closest(this._fieldSelector).querySelector(`.${this._inputErrorClass}`);
    ...
    _formValidation(validatingInput) {
      if (!validatingInput.validity.valid) {
        this._formShowError(this._fieldSelector, validatingInput, validatingInput.validationMessage, this._inputErrorClass, this._errorClass);
      }
      else {
        this._formHideError(this._fieldSelector, validatingInput, this._inputErrorClass, this._errorClass); 
      }
    }
